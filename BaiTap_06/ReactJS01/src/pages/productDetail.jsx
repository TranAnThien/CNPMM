                        ...
                        <button
                            ...
                            onClick={async () => {
                                ...
                                try {
                                    ...
                                    if (res?.success) {
                                        showToast('Đã thêm và chuyển đến thanh toán', { type: 'success' });
                                    ...
                                    showToast('Lỗi khi xử lý mua ngay', { type: 'error' });
                                }
                            }}
                            className="flex-1 inline-flex items-center justify-center rounded-2xl bg-blue-600 h-12 text-sm font-semibold text-white transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:bg-slate-400"
                        >
                            Mua ngay
                        </button>
