...
const RegisterPage = () => {
    ...
    const onSubmit = async (event) => {
        ...
        try {
            ...
            if (res?.EC === 0) {
                showToast('Tạo tài khoản thành công. Bạn có thể đăng nhập ngay bây giờ.', { type: 'success' });
                setTimeout(() => navigate('/login'), 1200);
            } else {
                setNotice({ type: 'error', message: res?.EM ?? 'Không thể tạo tài khoản. Vui lòng thử lại.' });
            }
        } catch (error) {
